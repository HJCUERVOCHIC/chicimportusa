// ============================================================
// ChicImportUSA — Iconos SVG
// Iconos inline para evitar dependencias externas.
// Todos cumplen: aria-hidden="true" (decorativos).
// Cuando se usan en botones, el botón lleva aria-label.
// ============================================================
...
export function IconTikTok({ className, size = 20 }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      xmlns="http://www.w3.org/2000/svg"
