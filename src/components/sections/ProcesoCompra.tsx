...
// Nota informativa que aparece después del paso 2
const notaBusqueda = {
  titulo: '¿Buscas algo que no esté publicado?',
  texto: 'También puedes escribirnos por WhatsApp y consultar si es posible buscar un producto específico. La disponibilidad y condiciones se confirman directamente por chat.',
}
    ...
    <section className="py-16 md:py-24 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden space-y-0">
          {pasos.map((paso, index) => (
            <div key={paso.numero}>
              ...
              {/* Nota informativa después del paso 2 - Mobile */}
              {paso.numero === 2 && (
                <div className="ml-12 mb-8 p-4 bg-gray-100 border border-gray-200 rounded-lg">
        ...
        <div className="hidden md:block">
          ...
          {/* Nota informativa después del paso 2 - Desktop */}
          <div className="mt-8 max-w-md mx-auto p-4 bg-gray-100 border border-gray-200 rounded-lg text-center">
            <p className="text-sm font-medium text-gray-700 mb-1">
              {notaBusqueda.titulo}
            </p>
            <p className="text-xs text-gray-500 leading-relaxed">
