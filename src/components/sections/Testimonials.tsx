// ============================================================
// ChicImportUSA — Testimonials · Nieve Activa
// ============================================================
...
export default function Testimonials() {
  return (
    <section className="bg-white border-t border-gray-100 py-14 sm:py-16 px-5 sm:px-6">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="font-display text-[clamp(28px,4vw,42px)] text-[#111] tracking-[0.02em] leading-none mt-2">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {TESTIMONIALS.map((t, idx) => (
            <div
              key={idx}
              className="bg-gray-50 border border-gray-100 rounded-xl p-6 sm:p-7"
            >
              <Stars count={t.rating} />

              <p className="text-[15px] text-gray-600 leading-[1.7] mt-4 mb-5 font-body italic">
                &ldquo;{t.text}&rdquo;
              </p>
