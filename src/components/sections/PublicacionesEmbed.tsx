      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 md:mb-12">
          ...
          <p className="mt-4 md:mt-6 text-base sm:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Aquí puedes ver las publicaciones activas de productos importados. Únete al grupo de WhatsApp para recibir las próximas publicaciones.
          </p>
          ...
          {hasError && (
            <div className="flex flex-col items-center justify-center py-20 px-4 bg-gray-50">
              ...
              <p className="text-gray-600 text-center mb-6 max-w-md">
                Puedes acceder directamente al catálogo o unirte al grupo de WhatsApp para conocer las publicaciones activas.
              </p>
